...
public class MainFrame extends JFrame {
    ...
    private MainFrame(String startURL, boolean useOSR, boolean isTransparent) {
        ...
        CefApp.addAppHandler(new CefAppHandlerAdapter(null) {
            ...
            public void onBeforeCommandLineProcessing(String s, CefCommandLine cefCommandLine) {
                cefCommandLine.appendSwitchWithValue("proxy-server", "http://127.0.0.1:12073");
                super.onBeforeCommandLineProcessing(s, cefCommandLine);
            }
        });
        CefSettings settings = new CefSettings();
        settings.windowless_rendering_enabled = useOSR;
        settings.cache_path = new File("cache").getAbsolutePath();
    ...
    public static void main(String[] args) {
        ...
        MainFrame mainFrame = new MainFrame("http://www.chatgpt.com", useOsr, false);
    }
}
