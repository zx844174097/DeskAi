...
//		System.setProperty("proxyPort","12083");
	...
	public static void main(String[] args) {
		LogInit();
		DataSave.APP_PATH(WebApp.class);
		...
		DataSave.context.init("cn.net.mugui.log","cn.net.mugui.net.pc.bean", "com.mugui.sqlite.bean"
		,"com.mugui.sqlite.dao","cn.net.mugui.net.pc.dblistener","cn.net.mugui.net.pc.manager"
		,"cn.net.mugui.net.pc.util","cn.net.mugui.net.task","cn.net.mugui.net.pc.dao","com.mugui.base","cn.net.mugui.net.web.util",
				"cn.net.mugui.web.tomcat","cn.net.mugui.net.pc.task");
		...
		try {
			...
			QQUtil qqUtil=DataSave.context.getBean(QQUtil.class);
			qqUtil.login();
